...
--# assume global class EFFECT_SINGLETON
...
--# assume global class CA_EFFECT_LIST
--# assume global class CA_EFFECT_BUNDLE
--# assume global class CA_EFFECT_BUNDLE_LIST
...
--# assume CA_UIC.CopyComponent: method(name: string) --> CA_Component
...
--# assume CM.force_character_force_into_stance: method(lookup: string, stance_key: string)
--spawning
...
--# assume CA_MILITARY_FORCE.active_stance: method() --> number
...
-- EFFECT
--# assume EFFECT_SINGLETON.get_localised_string: function(key: string) --> string
...
-- CA_EFFECT_BUNDLE
--# assume CA_EFFECT_BUNDLE.key: method() --> string
--# assume CA_EFFECT_BUNDLE.clone_and_create_custom_effect_bundle: method(MODEL_SCRIPT_INTERFACE_model: CA_MODEL) --> CA_CUSTOM_EFFECT_BUNDLE
--# assume CA_EFFECT_BUNDLE.duration: method() --> number
--# assume CA_EFFECT_BUNDLE.is_null_interface: method() --> boolean
--# assume CA_EFFECT_BUNDLE.effects: method() --> CA_EFFECT_LIST

-- CA EFFECT_SCRIPT_INTERFACE
--# assume CA_EFFECT.scope: method() --> string
--# assume CA_EFFECT.value: method() --> number
--# assume CA_EFFECT.key: method() --> string
--# assume CA_EFFECT.is_null_interface: method() --> boolean

-- CA_CUSTOM_EFFECT_BUNDLE
--# assume CA_CUSTOM_EFFECT_BUNDLE.remove_effect: method(EFFECT_SCRIPT_INTERFACE_effect: CA_EFFECT) --> boolean
--# assume CA_CUSTOM_EFFECT_BUNDLE.set_effect_value: method(EFFECT_SCRIPT_INTERFACE_effect: CA_EFFECT,_float32_new_value: number) --> boolean
--# assume CA_CUSTOM_EFFECT_BUNDLE.key: method() --> string
--# assume CA_CUSTOM_EFFECT_BUNDLE.add_effect: method(String_effect_key: string,_String_scope_key: string,_float32_value: number) --> boolean
--# assume CA_CUSTOM_EFFECT_BUNDLE.set_duration: method(card32_num_rounds: number)
--# assume CA_CUSTOM_EFFECT_BUNDLE.duration: method() --> number
--# assume CA_CUSTOM_EFFECT_BUNDLE.is_null_interface: method() --> boolean
--# assume CA_CUSTOM_EFFECT_BUNDLE.effects: method() --> CA_EFFECT_LIST
...
--# assume global effect: EFFECT_SINGLETON
...
--# assume global __game_mode: int
--# assume global __lib_type_campaign: int
--string extensions

--loading
--v [require] method(file: string) 
function cm:load_global_script(file)
