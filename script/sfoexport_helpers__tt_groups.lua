...
local units = {
    ...
    {"cst_carronade", "cst_special", 1},
    {"cst_pirate_merc", "cst_special", 1},
    {"cst_raiders", "cst_special", 1},
    
    --sfo dark elves
    {"def_dread", "def_special", 3},
    {"def_manticore_knight", "def_special", 3},
    
    --sfo dwarfs
    {"dwf_thunderers_1", "dwf_core"},
    {"dwf_sniper", "dwf_special", 1},
    {"dwf_everguard", "dwf_rare", 1},
    {"dwf_daemon_slayer", "dwf_rare", 1},
    ...
    {"emp_tank_ror", "emp_rare", 3},
    
    --sfo greenskins
    {"grn_forest_spear", "grn_core"},
    {"grn_black_orc_shields", "grn_special", 1},
    {"grn_savage_big_great", "grn_special", 1},
    {"grn_wyvern", "grn_special", 1},
    {"grn_black_orc_boss", "grn_rare", 1},
    {"grn_giant_squig", "grn_rare", 1},
    
    --sfo high elves
    {"hef_talons", "hef_core"},
    {"hef_handmaidens", "hef_special", 3},
    
    --sfo lizardmen
    {"lzd_skinks_red", "lzd_special", 1},
    {"lzd_eternity", "lzd_special", 3},
    
    --sfo norsca
    {"nor_whaler", "nor_special", 1},
    {"chs_marauder_mutant", "nor_special", 3},
    {"wh_dlc01_chs_inf_chosen_2", "nor_special", 2},
    {"wh_main_chs_inf_chosen_0", "nor_special", 2},
    {"wh_main_chs_inf_chosen_1", "nor_special", 2},
    
    --sfo skaven
    {"skv_black13", "skv_special", 3},
    
    -- vmp vampires
    {"vmp_blood_dragon", "vmp_rare", 1},
    {"vmp_zombie_dragon", "vmp_rare", 3},
    {"vmp_black_grail", "vmp_rare", 3},
    
    --sfo wood elves
    {"wef_eternal_sword", "wef_special", 2},
    {"wef_wildwood_warden", "wef_special", 2},
    {"wef_shadowdancer", "wef_rare", 1},
        ...
        {"wh2_dlc13_huntmarshall_veh_obsinite_gyrocopter_0_mercenary", "emp_rare", 2},
        ...
        --RARE
        {"wh_dlc06_dwf_inf_norgrimlings_irondrakes_0", "dwf_rare", 2},
        ...
        -------ROR-------
        --SPECIAL
        {"wh_pro04_chs_inf_chaos_warriors_ror_0", "chs_special", 1},
        ...
        {"wh2_dlc09_tmb_veh_khemrian_warsphinx_0", "tmb_special", 2},
